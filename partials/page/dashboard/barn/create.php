...
// Get All Medicines
$barnCategory = $db->getConnection()->prepare("SELECT * FROM barn_categories");
$barnCategory->execute();
$barns = $barnCategory->get_result()->fetch_all(MYSQLI_ASSOC);
?>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-lg-6">
      ...
      <div class="card card-body">
        ...
        <form enctype="multipart/form-data" action="<?= url('/dashboard/barn/store') ?>" method="POST">
